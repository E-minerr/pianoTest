...
// ========== 繧ｰ繝ｭ繝ｼ繝舌Ν螳壽焚(譌ｧOSC繝代ロ繝ｫ逕ｨ縲∽ｻ雁屓縺ｯ譛ｪ謠冗判縺縺碁未謨ｰ縺ｯ菫晄戟) ==========
#define SEC_OSC1   0
#define SEC_OSC2   250
...
// ========== UI謠冗判繝倥Ν繝代・(譌ｧOSC繝代ロ繝ｫ逕ｨ縲∽ｿ晄戟縺ｮ縺ｿ) ==========
...
void ofApp::draw() {
    ...
    // 蟾ｦMargin(遨ｺ縲∫畑騾比ｿ晉蕗 - decisions/2026-06-14.md貅匁侠) + 譫邱・
    ...
    // 蜿ｳMargin(遨ｺ縲√さ繝ｳ繝・く繧ｹ繝医・繝ｫ繝礼畑騾比ｿ晉蕗) + 譫邱・
    ...
    // 豁｣譁ｹ蠖｢繝｡繧､繝ｳ繧ｨ繝ｪ繧｢蜈ｨ菴薙・蟾ｦ蜿ｳ譫邱・main-monitor+step-buttons蜈ｱ騾・
    ...
    // 繝｡繧､繝ｳ繝｢繝九ち繝ｼ/繧ｹ繝・ャ繝励・繧ｿ繝ｳ縺ｮ蛹ｺ蛻・ｊ邱・
    ofSetColor(cyan); ofSetLineWidth(2); ofNoFill();
    ...
    // ========== SEQUENCER(繝｡繧､繝ｳ繝｢繝九ち繝ｼ+繧ｹ繝・ャ繝励げ繝ｪ繝・ラ) ==========
    if(seqUI) seqUI->draw(leftMarginW, squareTop);
}

// ========== buildKnobTable(譌ｧOSC繝代ロ繝ｫ逕ｨ縲∽ｿ晄戟縺ｮ縺ｿ繝ｻ譛ｪ謠冗判) ==========
